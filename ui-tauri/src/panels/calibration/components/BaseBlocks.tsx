...
export const ShiftArrow = ({
  ...
  <LayerGlyph
    path={direction === "up" ? "M8 14.5 12 10.5l4 4" : "M8 9.5 12 13.5l4-4"}
    size={size}
  />
);
...
export const SkeletonBlock = ({
  ...
  return (
    ...
    >
      ...
      {!hideTitle ? (
        <div style={{ ...titleStyle, marginTop: 8 }}>{title}</div>
      ) : null}
      {sample ? (
        <div
          style={{
            ...
            >
              <button
                ...
                style={{
                  ...
                  color:
                    hover === "up" ? "#7dd3fc" : "rgba(159, 183, 207, 0.64)",
                  cursor: "pointer",
                  padding: 0,
                  height: 16,
                  width: 22,
              ...
              <div
                style={{ width: "100%" }}
                onDoubleClick={() => onDoubleClickActiveValue?.()}
              >
                <ValueRail
                  size="mini"
              ...
              <button
                ...
                style={{
                  ...
                  background: "transparent",
                  color:
                    hover === "down" ? "#7dd3fc" : "rgba(159, 183, 207, 0.64)",
                  cursor: "pointer",
                  padding: 0,
                  height: 16,
                  width: 22,
