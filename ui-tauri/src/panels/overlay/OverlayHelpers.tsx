...
export const ANIMS: { id: TextAnim; label: string; icon: string }[] = [
  ...
  { id: "slide", label: "Kayma", icon: "M5 12h14M12 5l7 7-7 7" },
  {
    id: "blur",
    label: "Odak",
    icon: "M12 12m-3 0a3 3 0 1 0 6 0a3 3 0 1 0 -6 0M4 12a8 8 0 1 0 16 0",
  },
...
export const TS: React.CSSProperties = {
  display: "flex",
...
export const pageSubStyle: React.CSSProperties = {
  fontSize: 13,
  fontWeight: 400,
  ...
  >
    <button
      ...
      style={{
        ...
        color: on ? "rgba(159,183,207,0.56)" : "#7dd3fc",
        display: "inline-flex",
        alignItems: "center",
        justifyContent: "center",
    ...
    <button
      ...
      style={{
        ...
        color: on ? "#7dd3fc" : "rgba(159,183,207,0.56)",
        display: "inline-flex",
        alignItems: "center",
        justifyContent: "center",
        transition: "color 180ms ease",
...
export const Bar = ({
  ...
  const pd = (e: React.PointerEvent<HTMLDivElement>) => {
    ...
    const mv = (ev: PointerEvent) => {
      ...
      onDrag(Math.min(1, Math.max(0, (ev.clientX - rc.left) / rc.width)));
    };
    const up = () => {
    ...
    mv(e.nativeEvent as PointerEvent);
  };
  ...
  return (
    <div
      ref={ref}
      onPointerDown={onDrag ? pd : undefined}
      onWheel={onDrag ? pw : undefined}
      style={{
        padding: "10px 0",
        margin: "-10px 0",
      ...
      >
        <div
          style={{
            ...
            borderRadius: 999,
            background:
              "linear-gradient(90deg,rgba(125,211,252,0.50),rgba(125,211,252,0.80))",
  ...
  return (
    ...
    >
      ...
      >
        <button
          type="button"
          onClick={() => onChange(FONTS[Math.max(0, fi - 1)])}
          style={{
            border: "none",
            background: "transparent",
        ...
        <button
          type="button"
          onClick={() => onChange(FONTS[Math.min(FONTS.length - 1, fi + 1)])}
          style={{
            border: "none",
            background: "transparent",
            color: "rgba(159, 183, 207, 0.64)",
