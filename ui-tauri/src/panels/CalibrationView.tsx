...
const calibrationInfoContent: Record<CalibrationInfoKey, CalibrationInfoContent> = {
  overview: {
    title: 'Kalibrasyon Yardımı',
    what: 'İmlecin bulunduğu ayar veya grup için ana kalibrasyon sekmesindeki bilgi formatında açıklama gösterir.',
    lower: 'Ayar çubuğunda sola gitmek değeri azaltır.',
    higher: 'Ayar çubuğunda sağa gitmek değeri artırır.',
    mode: 'Bilgi butonu açıkken hover, wheel, focus ve sürükleme ile dinamik güncellenir.',
  },
  groupDecision: {
    title: 'Okuma Kararı',
    what: 'Metnin güvenilir, yeterince uzun ve tutarlı olup olmadığını birlikte değerlendirir.',
    lower: 'Daha hızlı ve esnek kabul davranışı verir. Ama yanlış okuma ve titreme artabilir.',
    higher: 'Daha temiz ve seçici sonuç verir. Ama bazı gerçek satırlar kaçabilir veya geç görünebilir.',
    mode: 'Her iki sahne modunda da temel karar katmanıdır.',
  },
  groupFlow: {
    title: 'İşleyiş',
    what: 'Filtre varyantlarının kaç farklı biçimde deneneceğini ve sahne uyumunun nasıl kontrol edileceğini belirler.',
    lower: 'Daha hafif ve hızlı çalışır. Ama zor görüntülerde başarı düşebilir.',
    higher: 'Daha fazla seçenek ve daha katı sahne kontrolü sağlar. Gecikme ve reddetme ihtimali artabilir.',
    mode: 'Filtre açıkken ve sahne ayrımı yaparken daha anlamlıdır.',
  },
  groupScene: {
    title: 'Sahne ve Kontrast',
    what: 'Şeritli ve şeritsiz sahnede metni arka plandan ayırmak için kontrast ve parlaklık kararlarını yönetir.',
    lower: 'Görüntü daha doğal kalır. Ama yazı yeterince öne çıkmayabilir.',
    higher: 'Metin daha belirgin olabilir. Ama arka plan sertleşebilir ve parlama oluşabilir.',
    mode: 'Seçili sahne moduna göre farklı etkiler gösterir.',
  },
  groupImage: {
    title: 'Görüntü Ayarı',
    what: 'Gürültü azaltma, kenar koruma ve adaptif eşik davranışını ayarlar.',
    lower: 'Detay daha fazla korunur. Ama gürültü veya zayıf ayrım kalabilir.',
    higher: 'Görüntü daha güçlü ayrıştırılır. Ama harfler yumuşayabilir veya çöp okuma artabilir.',
    mode: 'Filtre açıkken görüntü ön işleme davranışını etkiler.',
  },
  sensitivity: {
    title: 'Hassasiyet',
    what: 'Sistemin bir metni yeterince güvenilir bulup bulmadığını belirler.',
    lower: 'Sistem daha kolay kabul eder. Hız artar ama yanlış okuma da artabilir.',
    higher: 'Sistem daha seçici olur. Sonuç temizleşir ama bazı gerçek satırlar kaçabilir.',
    mode: 'Her iki modda da etkilidir.',
  },
  characters: {
    title: 'Karakter',
    what: 'Çeviriye gitmesi için metnin en az kaç karakter olacağını belirler.',
    lower: 'Kısa parçalar da geçer. Gürültü ve çöp metin artabilir.',
    higher: 'Rastgele kısa okumalar azalır. Ama kısa gerçek kelimeler de atlanabilir.',
    mode: 'Özellikle şeritsiz sahnede önemlidir.',
  },
  balance: {
    title: 'Denge',
    what: 'Yeni metnin ekrana çıkmadan önce kaç kez benzer biçimde görülmesi gerektiğini belirler.',
    lower: 'Metin daha hızlı görünür. Ama titreme ve sık değişim artabilir.',
    higher: 'Metin daha sakin akar. Ama ilk görünme süresi uzar.',
    mode: 'Her iki modda da önemlidir.',
  },
  attempts: {
    title: 'Deneme',
    what: 'Sistem filtre açıkken aynı kareyi kaç farklı biçimde deneyeceğini belirler.',
    lower: 'Daha hafif ve hızlı çalışır. Ama zor sahnelerde başarı düşebilir.',
    higher: 'Daha fazla seçenek dener. Doğruluk artabilir ama yük ve gecikme de artar.',
    mode: 'Filtre açıkken daha anlamlıdır.',
  },
  match: {
    title: 'Uyum',
    what: 'Seçtiğin sahne modunun görüntüye ne kadar uyduğunu kontrol eder.',
    lower: 'Sistem daha esnek davranır. Ama yanlış modla çalışma ihtimali artar.',
    higher: 'Sistem daha katı davranır. Uymayan sahneleri daha kolay reddeder.',
    mode: 'Sahne ayrımı yaparken etkilidir.',
  },
  claheStriped: {
    title: 'CLAHE Şeritli',
    what: 'Şeritli altyazıda yazıyı arka plandan daha belirgin ayırmaya çalışır.',
    lower: 'Görüntü daha doğal kalır. Ama yazı yeterince öne çıkmayabilir.',
    higher: 'Yazı daha belirginleşir. Ama görüntü sertleşebilir ve parlayabilir.',
    mode: 'Şeritli modda kullanılır.',
  },
  clahePlain: {
    title: 'CLAHE Şeritsiz',
    what: 'Şeritsiz sahnede yazıyı arka plandan ayırmak için kontrastı artırır.',
    lower: 'Görüntü ham kalır. Ama metin seçimi zayıflayabilir.',
    higher: 'Metin daha görünür olabilir. Ama arka plan da fazla sertleşebilir.',
    mode: 'Filtre açıkken şeritsiz modda etkilidir.',
  },
  whiteThreshold: {
    title: 'Beyaz Eşiği',
    what: 'Açık renkli yazıları seçerken ne kadar parlak alanın yazı sayılacağını belirler.',
    lower: 'Daha fazla açık alan yazı gibi algılanabilir. Gürültü artabilir.',
    higher: 'Sistem daha seçici olur. Ama soluk yazılar gözden kaçabilir.',
    mode: 'Açık renkli metinlerde işe yarar.',
  },
  bilateral: {
    title: 'Bilateral',
    what: 'Kumlanmayı azaltırken harf kenarlarını mümkün olduğunca korumaya çalışır.',
    lower: 'Detay korunur. Ama görüntü daha gürültülü kalabilir.',
    higher: 'Gürültü azalır. Ama harfler yumuşayıp bulanıklaşabilir.',
    mode: 'Filtre açıkken her iki modda da kullanılabilir.',
  },
  gaussianC: {
    title: 'Gaussian C',
    what: 'Şeritsiz sahnede yazıyı ayırırken gaussian filtresinin sertliğini ayarlar.',
    lower: 'Ayrım daha sert olur. Zayıf yazılar kaybolabilir.',
    higher: 'Ayrım daha yumuşar. Ama arka plan da yazı gibi algılanabilir.',
    mode: 'Filtre açıkken şeritsiz modda etkilidir.',
  },
  meanC: {
    title: 'Mean C',
    what: 'Şeritsiz sahnede ortalama tabanlı ayırmanın ne kadar gevşek ya da sıkı olacağını belirler.',
    lower: 'Daha sert davranır. Soluk yazılar kaybolabilir.',
    higher: 'Daha fazla alanı yazı sayabilir. Çöp okuma artabilir.',
    mode: 'Filtre açıkken şeritsiz modda etkilidir.',
  },
};
    ...
    >
      ...
      >
        ...
        <div style={{ marginTop: 8, display: 'grid', gap: 6, fontSize: 11, lineHeight: 1.5, color: 'rgba(191,215,242,0.84)' }}>
          ...
          <div><span aria-label="Mod" title="Mod" style={{ color: '#c4b5fd', fontWeight: 800 }}>â—‰</span> {displayInfo.mode}</div>
        </div>
      </div>
    </div>
  );
