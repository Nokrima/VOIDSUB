...
export const EngineInfoDock = ({
  info,
  visible,
}: {
  info?: (typeof engineInfoContent)["overview"];
  visible: boolean;
}) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div>
            <span style={{ color: "#93c5fd", fontWeight: 800 }}>•</span>{" "}
            {displayInfo.desc}
          </div>
          <div>
          ...
          <div>
            <span style={{ color: "#fcd34d", fontWeight: 800 }}>•</span>{" "}
            {displayInfo.detail2}
          </div>
          <div>
            <span style={{ color: "#c4b5fd", fontWeight: 800 }}>•</span>{" "}
            {displayInfo.detail3}
          </div>
        </div>
      </div>
