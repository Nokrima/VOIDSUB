...
export const SessionColumn: React.FC<SessionColumnProps> = ({
  isTranslating, isLoadingEngine, isFloating,
  sceneModeName, sceneModeBest, applySceneType,
  scanStatus, motorStatus, loopStatus,
  regionActionLabel, translationActionLabel,
  handleStartRegionSelect, handleToggleTranslation,
}) => (
<div
  style={{
    minHeight: 0,
      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: 13, fontWeight: 600, color: statusColor(motorStatus), flexShrink: 0 }}>
            {statusLabel(motorStatus, 'Aktif Motor', 'Aktif Motor', 'Aktif Motor', 'Yükleniyor...')}
          </span>
        </div>
        <div
          style={{
      ...
      >
        <motion.button
          ...
          style={{
            ...
            borderRadius: 999,
            background: scanStatus === 'active'
              ? 'rgba(134,239,172,0.08)'
              : 'rgba(255,255,255,0.04)',
            backdropFilter: 'blur(12px)',
            boxShadow: scanStatus === 'active'
