...
export interface ControlColumnProps {
  ...
  swapLanguages: () => void;
  languageArrowHover: 'source-up' | 'source-down' | 'target-up' | 'target-down' | null;
  setLanguageArrowHover: (v: 'source-up' | 'source-down' | 'target-up' | 'target-down' | null) => void;
...
export const ControlColumn: React.FC<ControlColumnProps> = ({
  isTranslating,
  currentPerformance, previousPerformance, nextPerformance, shiftPerformance,
  performanceArrowHover, setPerformanceArrowHover,
  currentMotor, previousMotor, nextMotor, shiftMotor,
  motorArrowHover, setMotorArrowHover,
  activeService, previousService, nextService, shiftService,
  serviceArrowHover, setServiceArrowHover,
  activeModel, previousModel, nextModel, shiftModel, modelEnabled,
  modelArrowHover, setModelArrowHover,
  sourceLanguage, targetLanguage, shiftSourceLanguage, shiftTargetLanguage,
  swapLanguages, languageArrowHover, setLanguageArrowHover,
  languageSwapHover, setLanguageSwapHover,
}) => {
