...
export default function Onboarding({ onComplete }: OnboardingProps) {
  ...
  useEffect(() => {
    const unsubscribeHello = onEvent("hello", (data) => {
      ...
      if (payload && payload.hw_info) {
        ...
        setSelectedEngine(
          payload.hw_info.recommended_engine ||
            payload.hw_info.available_engines[0] ||
            "easy",
        );
      }
    });
    ...
    const unsubscribeHardwareLegacy = onEvent("hardware_result", (data) => {
      ...
      setHwData(payload);
      setSelectedEngine(
        payload.recommended_engine || payload.available_engines[0] || "easy",
      );
    });
  ...
  useEffect(() => {
    const checkSettings = (data: any) => {
      ...
      if (
        appData.onboarding_completed &&
        appData.ocr_engine === selectedEngine
      ) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-hidden bg-[radial-gradient(circle_at_top,rgba(46,132,255,0.16),transparent_28%),linear-gradient(180deg,#0b1120_0%,#06080d_100%)] text-slate-100">
      ...
      <AnimatePresence mode="wait">
            ...
            <motion.div
              ...
              animate={{
                transform: [
                  ...
                  "translate3d(-10px,8px,0) scale(1.04)",
                  "translate3d(0,0,0) scale(1)",
                ],
                opacity: [0.72, 1, 0.72],
              }}
        ...
        {step === 2 && (
          ...
          >
            <div
              className="pointer-events-auto w-full max-w-4xl px-6 py-8"
              style={{
            ...
            >
              ...
              <div className="text-center">
                ...
                >
                  {tutorialStep}/{totalSteps} · {stepLabel}
                </div>
                <h2 className="mt-3 text-2xl font-bold tracking-tight text-white">
                  Sistem Taranıyor
                </h2>
                <p className="mx-auto mt-2 max-w-xl text-sm leading-6 text-slate-400">
                  Donanım, uygun motorlar ve ilk çalışma dengesi kontrol
                  ediliyor.
                </p>
              </div>
              ...
              {hwData ? (
                  ...
                  <div className="grid gap-3 md:grid-cols-3">
                    ...
                    >
                      ...
                      <div className="mt-1 text-[11px] font-medium text-slate-400">
                        {hwData.cpu.cores} çekirdek / {hwData.cpu.threads} izlek
                      </div>
                    </div>
                    <div
                      className="text-left"
                      ...
                      <div className="mt-1 text-[11px] leading-[1.4] text-slate-400">
                        {hwData.gpu.available ? (
                          ...
                          <div className="flex flex-col gap-1.5 mt-1 text-[10px]">
                            <span>
                              Harici hızlandırma (CUDA) tespit edilmedi.
                            </span>
                            <span>
                              CPU modunda çeviri hızı nispeten yavaş olacaktır.
                            </span>
                          </div>
                        )}
                      </div>
                ...
                <div className="mt-10 flex flex-col items-center justify-center py-8">
                  ...
                  <span className="mt-4 text-[11px] font-bold uppercase tracking-wider text-slate-400">
                    Motorlar Doğrulanıyor...
                  </span>
                </div>
              )}
            </div>
            ...
            >
              ...
              <div className="mb-6 text-center">
                ...
                <h2 className="mt-3 text-2xl font-bold text-white">
                  İlk uygun motoru doğrula
                </h2>
                <p className="mx-auto mt-2 max-w-xl text-sm leading-6 text-slate-400">
                  Kullanılabilir motorlar arasından ilk deneme için uygun olanı
                  seçebilirsin.
                </p>
              </div>
                ...
                <div className="mx-auto flex w-full flex-wrap justify-center gap-4">
                  {hwData.available_engines.map((engine) => (
                    <button
                      ...
                      style={{
                        flex:
                          hwData.available_engines.length === 1
                            ? "0 1 320px"
                            : "0 1 260px",
                        background:
                        ...
                        boxShadow:
                          selectedEngine === engine
                            ? "inset 0 0 0 1px rgba(125,211,252,0.1), 0 0 20px rgba(125,211,252,0.05)"
                            : "none",
                      }}
                    >
                      <div
                        style={{
                          ...
                          color:
                            selectedEngine === engine
                              ? "#7dd3fc"
                              : "rgba(191,215,242,0.5)",
                          textTransform: "uppercase",
                        }}
                      >
                        {hwData.recommended_engine === engine
                          ? "Önerilen Motor"
                          : "Seçilebilir"}
                      </div>
                      ...
                      <div className="mt-1 text-[11px] font-medium text-slate-400">
                        {engine === "easy"
                          ? "Yapay zeka odaklı derin öğrenme motoru."
                          : "Yerel Windows OCR motoru (hızlı)."}
                      </div>
                    </button>
                  ))}
                </div>
              ...
              <div className="mt-8 flex justify-center">
                <ActionButton onClick={() => setStep(4)} disabled={!hwData}>
                  Devam Et
                </ActionButton>
              </div>
            </div>
        ...
        {step === 4 && (
          ...
          >
            <div
              className="pointer-events-auto w-full max-w-3xl px-6 py-8"
              style={{
                background: "rgba(255,255,255,0.02)",
                border: "1px solid rgba(255,255,255,0.05)",
                borderRadius: 24,
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="mx-auto mt-2 text-sm leading-6 text-slate-400">
                  İlk kurulum sonunda uygulanacak başlangıç tercihleri aşağıdaki
                  gibi olacak.
                </p>
              </div>
              ...
              <div className="mt-6 grid gap-3">
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  ...
                  >
                    ...
                    <div className="mt-1.5 text-[12px] leading-[1.5] text-slate-300">
                      Güvenli varsayılanlar ve ilk test için performanslı
                      ayarlar.
                    </div>
                  </div>
                  <div
                  ...
                  >
                    ...
                    <div className="mt-1.5 text-[12px] leading-[1.5] text-slate-300">
                      Ana ekranda "Çeviriyi Başlat" tuşu ile test
                      yapabilirsiniz.
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-8 flex justify-center">
                <ActionButton onClick={() => setStep(5)}>
                  Kurulumu Bitir
                </ActionButton>
              </div>
            </div>
        ...
        {step === 5 && (
          ...
          >
            <div
              className="pointer-events-auto w-full max-w-2xl px-6 py-10 text-center"
              style={{
                background: "rgba(255,255,255,0.02)",
                border: "1px solid rgba(255,255,255,0.05)",
                borderRadius: 24,
            ...
            >
              ...
              <div className="mt-8 flex justify-center">
                <ActionButton onClick={finishOnboarding}>
                  VOIDSUB'ı Başlat
                </ActionButton>
              </div>
            </div>
