...
_SAFE_SPLIT_WORDS = {
    "a", "all", "an", "and", "answer", "are", "at", "be", "but", "by", "can",
    "do", "else", "find", "for", "from", "get", "give", "go", "had", "has",
    "have", "he", "her", "him", "how", "i", "if", "in", "into", "is", "it",
    "know", "make", "me", "my", "now", "of", "on", "one", "or", "out", "she",
    "that", "the", "their", "them", "then", "there", "they", "this", "to",
    "up", "us", "was", "we", "what", "when", "where", "who", "why", "will",
    "with", "would", "you", "your",
}
...
def clean_ocr_source_detailed(text: str) -> dict[str, object]:
    ...
    return {"text": cleaned, "changed": cleaned != original, "steps": steps, "minor_merge_fixes": minor_merge_fixes}
